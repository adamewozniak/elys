...
func (_m *OracleKeeper) GetPriceFeeder(ctx types.Context, feeder string) (oracletypes.PriceFeeder, bool) {
	ret := _m.Called(ctx, feeder)

	var r0 oracletypes.PriceFeeder
	var r1 bool
	if rf, ok := ret.Get(0).(func(types.Context, string) (oracletypes.PriceFeeder, bool)); ok {
		return rf(ctx, feeder)
	}
	if rf, ok := ret.Get(0).(func(types.Context, string) oracletypes.PriceFeeder); ok {
		r0 = rf(ctx, feeder)
	} else {
...
func (_c *OracleKeeper_GetPriceFeeder_Call) Run(run func(ctx types.Context, feeder string)) *OracleKeeper_GetPriceFeeder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(string))
	})
	return _c
...
func (_c *OracleKeeper_GetPriceFeeder_Call) RunAndReturn(run func(types.Context, string) (oracletypes.PriceFeeder, bool)) *OracleKeeper_GetPriceFeeder_Call {
	_c.Call.Return(run)
	return _c
}
